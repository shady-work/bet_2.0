        ...
        <div class="head">
            <div class="details">
                ...
                <div class="left">
                    ...
                    <p class="color-white">第&nbsp;{{$store.state.egg.lastExpect}}&nbsp;期开奖结果&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;今日期数 {{sales_}}/179</p>
                    <div class="balls">
        ...
        methods:
            {
                ...
                comfire_bet: function ()
                {
                    ...
                    for(let i = 0; i<this.bets.length;i++)
                    {
                        ...
                        <td><button  class='${this.bets[i].content}' attr='my-btn-4'>删除</button></td>
                     </tr>`;
                        //算下注的总金额
        ...
        created : function ()
        {
            ...
            else
            {
                this.$http.get(this.global.config.API + "user/" + window.sessionStorage.user_id ).then(function (response)
                {
                    ...
                    if(this.vaild_lotteries.indexOf('pcegg') != -1)
                    {
                        this.get_odds();
                        this.get_last_code();
                        this.get_time();
